...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-white px-6 sm:px-8 lg:px-8 py-3 lg:flex dark:bg-white",
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto w-full max-w-7xl flex-row items-center justify-between bg-white/80 px-6 sm:px-8 lg:px-8 py-3 lg:hidden",
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 mx-4 flex flex-col items-start justify-start gap-4 rounded-lg bg-white px-6 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
            outfit.className,
            className,
          )}
        >
...
export const NavbarLogo = () => {
  return (
    <a href="#" className={cn("relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black", outfit.className)}>
      ...
      <span className="font-semibold text-3xl text-black hidden lg:block">Construction</span>
    </a>
  )
}
